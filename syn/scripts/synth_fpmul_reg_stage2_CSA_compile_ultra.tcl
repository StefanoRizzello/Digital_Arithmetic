...
elaborate FPmul -arch pipeline -lib WORK > reports/reports_synth_fpmul_reg_stage2_CSA_compile_ultra/elaborate.txt
#filter contains multiple instances of reg, need to uniquify
uniquify 
link
ungroup -all -flatten
set_implementation DW02_mult/csa [find cell I2/mult_156]
}
...
compile_ultra
report_timing > reports/reports_synth_fpmul_reg_stage2_CSA_compile_ultra/report_timing_${clk_var}_ns.txt
report_area > reports/reports_synth_fpmul_reg_stage2_CSA_compile_ultra/report_area_clk_${clk_var}_ns.txt
report_resources > reports/reports_synth_fpmul_reg_stage2_CSA_compile_ultra/report_resources_clk_${clk_var}_ns.txt
quit
}
