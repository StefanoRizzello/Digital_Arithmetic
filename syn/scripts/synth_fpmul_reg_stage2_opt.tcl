...
elaborate FPmul -arch pipeline -lib WORK > reports/reports_synth_fpmul_reg_stage2_opt/elaborate.txt
...
compile
optimize_registers
report_timing > reports/reports_synth_fpmul_reg_stage2_opt/report_timing_${clk_var}_ns.txt
report_area > reports/reports_synth_fpmul_reg_stage2_opt/report_area_clk_${clk_var}_ns.txt
report_resources > reports/reports_synth_fpmul_reg_stage2_opt/report_resources_clk_${clk_var}_ns.txt
quit
}
