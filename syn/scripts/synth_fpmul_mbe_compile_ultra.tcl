...
elaborate FPmul -arch pipeline -lib WORK > reports/reports_synth_fpmul_mbe_compile_ultra/elaborate.txt
...
compile_ultra
report_timing > reports/reports_synth_fpmul_mbe_compile_ultra/report_timing_${clk_var}_ns.txt
report_area > reports/reports_synth_fpmul_mbe_compile_ultra/report_area_clk_${clk_var}_ns.txt
report_resources > reports/reports_synth_fpmul_mbe_compile_ultra/report_resources_clk_${clk_var}_ns.txt
quit
}
