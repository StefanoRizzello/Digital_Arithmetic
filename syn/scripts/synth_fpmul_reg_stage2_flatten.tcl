...
analyze -f vhdl -lib WORK ../hdl/src/fpmul_pipeline_reg/stage2_reg/fpmul_stage2_struct_reg.vhd
...
elaborate FPmul -arch pipeline -lib WORK > reports/reports_synth_fpmul_reg_stage2_flatten/elaborate.txt
...
compile
report_timing > reports/reports_synth_fpmul_reg_stage_flatten/report_timing_${clk_var}_ns.txt
report_area > reports/reports_synth_fpmul_reg_stage2_flatten/report_area_clk_${clk_var}_ns.txt
report_resources > reports/reports_synth_fpmul_reg_stage2_flatten/report_resources_clk_${clk_var}_ns.txt
quit
}
