...
elaborate FPmul -arch pipeline -lib WORK > reports_synth_fpmul_reg_stage2CSA/elaborate.txt
...
compile
report_timing > reports_synth_fpmul_reg_stage2CSA/report_timing_${clk_var}_ns.txt
report_area > reports_synth_fpmul_reg_stage2CSA/report_area_clk_${clk_var}_ns.txt
report_resources > reports_synth_fpmul_reg_stage2CSA/report_resources_clk_${clk_var}_ns.txt
quit
}
